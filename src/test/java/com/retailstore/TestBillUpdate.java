...
public class TestBillUpdate {
	...
	public BillUpdateInfo createTestBean() {
		...
		productsToBeAdded.add(new ProductInfoForBill("ORS-1234", 20));
		productsToBeAdded.add(new ProductInfoForBill("ORS-2234", 30));
		productsToBeAdded.add(new ProductInfoForBill("ORS-3234", 10));

		List<ProductInfoForBill> productsToBeRemoved = new ArrayList<ProductInfoForBill>();
		productsToBeRemoved.add(new ProductInfoForBill("ORS-1235", 2));
		productsToBeRemoved.add(new ProductInfoForBill("ORS-1236", 3));
		productsToBeRemoved.add(new ProductInfoForBill("ORS-1237", 1));
